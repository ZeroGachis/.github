...
NB_THREADS="15"
WARN_ERROR_EXCLUDE='{"error": "all", "warn": ["NoNodesForSelectionCriteria", "NothingToDo", "PackageMaterializationOverrideDeprecation", "DeprecationsSummary", "LogTestResult", "CustomTopLevelKeyDeprecation"]}'
